...
variable "instance_count" {
  description = "The number of web server instances. MUST be set in a .tfvars file."
  type        = number
}

variable "machine_type" {
  description = "The machine type for the web server instances. MUST be set in a .tfvars file."
  type        = string
}
